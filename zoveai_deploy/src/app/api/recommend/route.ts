...
${exclude?.length ? `- Already suggested (DO NOT repeat): ${exclude.join(', ')}` : ''}
...
Return exactly 3 destinations. Make them meaningfully different. Never repeat excluded destinations.`;
